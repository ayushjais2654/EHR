            ...
            <div>
                <section id="home" >
                    <header>
                        <div class="container">
                            <div class="left">
                                <a href="" class="logo" id="homeNav5">chainCure</a>
                                <div class="hm-menu">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                            ...
                            <div class="right">
                                <nav id = "homeNav">
                                    <ul>
                                        <li id= "homeNav1"><a href="/">Home</a></li>
                                        <li id="homeNav2"><a href="/patientLogin">Patient</a></li>
                                        <li id="homeNav3"><a href="/doctorLogin">Doctor</a></li>
                                        <li id="homeNav4"><a href="/hospitalLogin">Hospital</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
